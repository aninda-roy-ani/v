...
%load Exp1.mat;
%load U:\Workspace\IntruderDet\SUPRIYO\New500Images\Exp1.mat X sigma_star;
load ('F:\thesis\matlab-deep-learning-mtcnn-face-detection-a0a8ecc\code\mtcnn\+mtcnn\toTestGaborR\Exp0.mat', 'P1', 'P2', 'A');
...
%anomalies = [14 20:22 30:32 3 40:45 51 61:62 78 94:95 105:106 111:114 135 152 162 164];
%anomalies = [21, 32, 53, 74, 104, 116, 127, 148, 169, 185];
anomalies = [6,10,12,13,14,15,24,25,31,32,35,39,40,43,44,47,48,51,53,54,60,62,63,65,73];
