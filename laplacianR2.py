...
output_path = "F:/thesis/matlab-deep-learning-mtcnn-face-detection-a0a8ecc/code/mtcnn/+mtcnn/toTestLaplacianR2/" ##It is the path to images to where it will write
