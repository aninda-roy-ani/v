%{.
 clc; clear all;
jpgFiles = dir('F:\thesis\matlab-deep-learning-mtcnn-face-detection-a0a8ecc\code\mtcnn\+mtcnn\datasetR2\*.jpg');
...
for k = 1:length(jpgFiles)
    ...
    cd 'F:\thesis\matlab-deep-learning-mtcnn-face-detection-a0a8ecc\code\mtcnn\+mtcnn\datasetR2\'; 
    im = imread(filename);
    ...
    if numel(scores)==1
        ...
        for k = 1 : size(bboxes, 1)
            ...
            cd 'F:\thesis\matlab-deep-learning-mtcnn-face-detection-a0a8ecc\code\mtcnn\+mtcnn\croppedR2\';
            filename
